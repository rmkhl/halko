...
export const en = {
  ...
  notes: {
    ...
    help: "Recorded with the time, the current step and the temperatures.",
    cancel: "Cancel",
    save: "Add",
    none: "No notes were taken during this run",
    failed: "Could not save the note. It is still here - try again.",
    at: "{{time}} · {{step}}",
    temperatures: "Kiln {{kiln}} °C · Material {{material}} °C",
  },
  programs: {
    ...common(),
