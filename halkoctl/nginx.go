...
func handleNginxCommand() {
	...
	nginxConfig := generateNginxConfig(*port, controlunitHost, controlunitPort, sensorHost, sensorPort, powerHost, powerPort, storageHost, storagePort)
...
func generateNginxConfig(listenPort int, controlunitHost, controlunitPort, sensorHost, sensorPort, powerHost, powerPort, storageHost, storagePort string) string {
...
`, listenPort, controlunitHost, controlunitPort, sensorHost, sensorPort, powerHost, powerPort, storageHost, storagePort)
}
