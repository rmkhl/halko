...
{
  "name": "New Program",
  "description": "A new drying program",
  "phases": [
    "Phase 1",
    "Phase 2"
  ]
...
Gets a specific program by name.
...
Updates a specific program by name.
...
Updates a specific phase by name.

**Path Parameters:**
- `name`: The name of the phase to update

**Request Format:**
```json
{
  "duration": 4800,
  "targetTemperature": 48,
  "minTemperature": 43,
  "maxTemperature": 53,
  "fanPower": 90,
  "humidifierPower": 10
